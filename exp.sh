...
python main.py --config demo03 --stage 2 --tag qry0,qry1
...
python main.py --config demo05 --stage 2 --tag qry0,qry1

# Meta-model with GRU dynamics (Jiang et al, MICCAI 2022)
python main.py --config demo06 --stage 1
python main.py --config demo06 --stage 2 --tag qry0,qry1
